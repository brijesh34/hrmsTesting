...
module.exports = function (app) {
    ...
    app.get("/api/leave/pendingLeaveAll", authJwt.verifyToken, controller.pendingLeaveAll);
    ...
    app.get("/api/leave/leaveManagementInfoAll", authJwt.verifyToken, controller.leaveManagementInfoAll);
